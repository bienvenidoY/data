/**
 * 出处 https://www.taojunnan.com/views/vue/2021/091701.html#%E4%BB%A3%E7%A0%81%E5%AE%9E%E7%8E%B0
 * weather.js
  ...
  for (const weatherKey in iconWeatherMap) {
    if (Object.hasOwnProperty.call(iconWeatherMap, weatherKey)) {
      ...
      if (findWeatherItem) {
        ...
        url = require(`./icons/${weatherKey}.png`)
  ...
  return new Promise((resolve, reject) => {
    ...
    weather.getForecast(adcode, (err, data) => {
      if (!err) {
        ...
        const { dayWeather } = data.forecasts[0]
        const weatherData = Object.assign({}, data, {url: _getIcon(dayWeather)})
        resolve(weatherData)
      } else {
